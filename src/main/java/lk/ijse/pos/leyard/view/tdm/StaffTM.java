...
public class StaffTM implements Comparable<StaffTM> {
    ...
    public StaffTM(String staff_id, String staff_name, String address, double salary, String role) {
    ...
    @Override
    public int compareTo(StaffTM o) {
        return staff_id.compareTo(o.getStaff_id());
    }
}
