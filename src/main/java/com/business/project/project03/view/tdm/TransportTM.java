...
public class TransportTM implements Comparable<TransportTM> {
    ...
    public TransportTM(String transport_id, String transport_type, String start_date, String end_date, String driver_id) {
    ...
    @Override
    public int compareTo(TransportTM o) {
        return transport_id.compareTo(o.getTransport_id());
    }
}
