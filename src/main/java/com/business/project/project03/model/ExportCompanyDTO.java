...
public class ExportCompanyDTO implements Serializable {
    ...
    public ExportCompanyDTO(String company_ID, String company_Name, String country, String contact, String email) {
